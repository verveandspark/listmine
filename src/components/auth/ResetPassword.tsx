    ...
    <div className="min-h-screen bg-gradient-to-br from-[#F5F8FA] via-white to-[#E6F4F4] flex items-center justify-center p-4">
      <div className="w-full max-w-md">
        ...
        <div className="text-center mb-8">
          ...
          />
          <div id="logo-fallback" style={{ display: 'none' }} className="inline-flex items-center justify-center mb-4">
            <img src="/assets/listmine-icon.png" alt="ListMine" className="h-16" />
          </div>
